    ...
    try {
      ...
      switch (action) {
        ...
        case 'updateSettings':
          ...
          break;
        case 'export':
          response = await api.get(`/api/admin/reports/${id}?format=csv`, { responseType: 'blob' });
      ...
      >
        {selectedItem ? (
          <div>
            ...
            <pre className="bg-gray-100 p-4 rounded">{JSON.stringify(selectedItem, null, 2)}</pre>
            <div className="mt-4">
